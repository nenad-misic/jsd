...
class ExpressGenerator(Generator):
    ...
    def generate_code(self):
        ...
        self.generateModelTemplate(serverjsTemplate, 'express/autogenerated/baseServer.js', wipeout=True)
        ...
        for entity in self.model.entities:
            ...
            self.generateEntityTemplate(baseRouterTemplate, f'express/autogenerated/routes/base_{entity.name.lower()}_routes.js', entity, wipeout=True)
            ...
            self.generateEntityTemplate(baseServiceTemplate, f'express/autogenerated/services/base_{entity.name.lower()}_service.js', entity, wipeout=True)
            ...
            self.generateEntityTemplate(baseRepositoryTemplate, f'express/autogenerated/repositories/base_{entity.name.lower()}_repository.js', entity, wipeout=True)
